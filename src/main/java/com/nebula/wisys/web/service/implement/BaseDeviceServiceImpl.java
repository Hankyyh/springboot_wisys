...
public class BaseDeviceServiceImpl implements BaseDeviceService {
    ...
    @Override
    public List<BaseDevice> getBaseDeviceByPID(String pidStr) throws MissingServletRequestParameterException {
		...
		if (paramPID.isPIDForAll()) {
			...
			throw new MissingServletRequestParameterException("pid", "ObjectID (24-length hex string)");
    ...
    @Override
	public BaseDevice updateBaseDevice(BaseDevice baseDevice) throws MissingServletRequestParameterException {
    ...
    @Override
	public List<BaseDevice> deleteBaseDeviceByPID(String pidStr) throws MissingServletRequestParameterException {
		List<BaseDevice> baseDeviceList = new ArrayList<BaseDevice>();
		HttpUrlParamPID paramPID = new HttpUrlParamPID(pidStr);
